...
const Notes=(props)=> {
  ...
  const handleClick =(e)=>
  {     
       console.log("updateting the notes")
        ...
        <div className="modal-dialog">
          <div className="modal-content">
            ...
            <div className="modal-body">
              <form className='my-3'>
                ...
                <div className="mb-3">
                  ...
                  <input type="text" name="etag" className="form-control" id="etag" onChange={onChange} value={note.etag} minLength={5} required  />
                </div>
            ...
            <div className="modal-footer">
              ...
              <button disabled={note.etitle.length<5 || note.edescription.length<5  || note.etag.length<5 } type="button" className="btn btn-primary" onClick={handleClick}>Update changes</button>
            </div>
          </div>
        </div>
      </div>
